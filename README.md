...
* [Курсовая работа в Google Docs (позже)]()
...
- [Отчёт по курсовой работе в формате *PDF* (позже)]()
...
> [!IMPORTANT] 
> Поставленные цели курсовой работы **пока** были не достигнуты.